...
public class UserServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (method != null && method.equals("add")) {
			...
			this.getUserById(request, response, "userUpdate.jsp");
		...
		}else if (method != null && method.equals("passwordlist")) {
			this.passwordlist(request, response);
	...
	private void addpage(HttpServletRequest request,
		...
		request.getRequestDispatcher("WEB-INF/jsp/user/userAdd.jsp").forward(request,
				response);
	}

	private void passwordlist(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
		request.getRequestDispatcher("WEB-INF/jsp/user/password.jsp").forward(request,
				response);
	...
	private void modify(HttpServletRequest request, HttpServletResponse response)
		...
		if (userService.modify(user)) {
			...
			request.getRequestDispatcher("/jsp/userUpdate.jsp").forward(
					request, response);
	...
	private void getUserById(HttpServletRequest request,
		...
		if (!StringUtils.isNullOrEmpty(id)) {
			...
			request.getRequestDispatcher("/WEB-INF/jsp/user/"+url).forward(request, response);
		}
	}
	...
	private void add(HttpServletRequest request, HttpServletResponse response)
		...
		if (userService.add(user)) {
			System.out.println(userService.add(user)+"true");
			request.getRequestDispatcher("/user.do?method=query").forward(
					request, response);
		} else {
			System.out.println(userService.add(user)+"false");
			request.getRequestDispatcher("WEB-INF/jsp/user/userAdd.jsp").forward(request,
					response);
		}
	}
	...
	private void query(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("userList", userList);
		request.setAttribute("queryUserName", queryUserName);
		request.getRequestDispatcher("WEB-INF/jsp/user/userList.jsp").forward(request,
				response);
	}
}
