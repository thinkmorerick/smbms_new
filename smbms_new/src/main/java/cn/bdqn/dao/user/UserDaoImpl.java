...
public class UserDaoImpl implements UserDao {
	...
	public int add(Connection connection, User user) throws Exception {
		...
		if (null != connection) {
			String sql = "insert into smbms_user (userCode,userName,userPassword,"
					+ "userType,gender,birthday,phone,address,createDate,createBy"
					+ ")" + "values(?,?,?,?,?,?,?,?,?,?)";
	...
	public User getLoginUser(Connection connection, String userCode)
		...
		if (null != connection) {
			...
			if (rs.next()) {
				...
				_user.setCreateDate(rs.getTimestamp("createDate"));
	...
	public List<User> getPageUserList(Connection connection, String userName,
		...
		List<User> userList = new ArrayList<User>();
		if (connection != null) {
			String sql = "select * from smbms_user where userName like ? order by createDate desc limit ?,?";
