...
public class BillServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (method != null && method.equals("query")) {
			...
			this.getBillById(request, response, "billUpdate.jsp");
		...
		}else if (method != null && method.equals("billadd")) {
			this.billaddpage(request, response);
		}
	}
	
	private void billaddpage(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
		request.getRequestDispatcher("WEB-INF/jsp/bill/billAdd.jsp").forward(request,
				response);
	...
	private void modify(HttpServletRequest request, HttpServletResponse response)
		...
		if (flag) {
			...
			request.getRequestDispatcher("WEB-INF/jsp/bill/billmodify.jsp").forward(request,
					response);
		}
	...
	private void getBillById(HttpServletRequest request,
		...
		if (!StringUtils.isNullOrEmpty(id)) {
			...
			request.getRequestDispatcher("/WEB-INF/jsp/bill/"+url).forward(request, response);
		}
	...
	private void query2(HttpServletRequest request, HttpServletResponse response)
		...
		request.getRequestDispatcher("WEB-INF/jsp/bill/billlist.jsp").forward(request,
				response);
	}
